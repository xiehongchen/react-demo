 ...
 * @Date: 2024-01-23 11:40:33
 * @LastEditors: xiehongchen 1754581057@qq.com
 * @LastEditTime: 2024-01-24 10:51:57
 * @FilePath: /react-demo/src/pages/Publish/index.tsx
      ...
      <Card
        ...
        >
          ...
          <Form.Item label="频道" name="channel_id" rules={[{ required: true, message: '请选择文章频道' }]}>
            <Select
              style={{ width: 120 }}
              options={channelStore.channelList.map((item: any) => ({ label: item.name, value: item.id }))}
            />
          </Form.Item>
          <Form.Item label="封面">
            <Form.Item name="type">
